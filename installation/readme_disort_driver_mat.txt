...
1) The standard DISORT version 2.0 available at Wiscombe's NASA ftp site: ftp://climate1.gsfc.nasa.gov/wiscombe/ (README.txt is the readme from the DISORT team that accompanies the DISORT code). Minor modifications have been made to DISORT (see Notes below). 
